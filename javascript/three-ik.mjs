import { AxesHelper, Color, ConeBufferGeometry, MathUtils, Matrix4, Mesh, MeshBasicMaterial, Object3D, Vector3 } from './three.mjs';
...
var DEG2RAD = MathUtils.degToRad;
var RAD2DEG = MathUtils.radToDeg;
